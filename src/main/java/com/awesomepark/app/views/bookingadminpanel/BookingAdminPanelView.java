...
@PageTitle("Booking Admin Panel")
@Route(value = "Booking-Admin-Panel/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class BookingAdminPanelView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "Booking-Admin-Panel/%s/edit";
    ...
    public BookingAdminPanelView(SamplePersonService samplePersonService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(BookingAdminPanelView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(BookingAdminPanelView.class);
            }
        }
    }
